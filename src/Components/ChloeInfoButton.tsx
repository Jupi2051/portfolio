...
import "../Styles/ChloeInfoButton.css";

type PropTypes = {
    setRenderChloe: (render: boolean) => void,
    setConversationIndex: (index: number) => void,
    conversationIndex: number,
}

function ChloeInfoButton(props: PropTypes)
{
    function showChloe()
    {
        props.setConversationIndex(props.conversationIndex);
        props.setRenderChloe(true);
    }
    ...
    return <div className="chloe-button-container" onClick={onClickChloe}>
        <svg className="sparkles" width="800px" height="800px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <img className="chloe-logo" src="/Imgs/Chloe/Logo.webp" />
    </div>
}

export default ChloeInfoButton;