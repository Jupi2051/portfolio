        ...
        {tab === "headers" ? (
          <div className="flex h-full min-h-[140px] flex-col gap-1">
            ...
            <textarea
              ...
              spellCheck={false}
              className="min-h-[120px] flex-1 resize-none rounded border border-ctp-surface1 bg-ctp-base p-2 font-mono text-xs text-ctp-text outline-none focus-visible:ring-1 focus-visible:ring-ctp-mauve/50"
