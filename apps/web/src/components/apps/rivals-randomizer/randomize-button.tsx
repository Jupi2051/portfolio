...
export default function RandomizeButton({ onClick, disabled, label }: RandomizeButtonProps) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`[clip-path:polygon(16px_0,100%_0,calc(100%-16px)_100%,0_100%)] cursor-pointer bg-linear-to-r from-ctp-mauve via-ctp-lavender to-ctp-mauve px-11 py-3 font-jockey-one text-lg tracking-widest text-ctp-crust uppercase shadow-lg shadow-ctp-lavender/40 transition-all duration-150 hover:scale-105 hover:shadow-ctp-lavender/70 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:scale-100 ${
